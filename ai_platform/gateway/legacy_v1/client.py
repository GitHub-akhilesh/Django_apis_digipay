...
EXCLUDED_ENDPOINTS: Tuple[Tuple[str, str, str, str], ...] = (
    ...
    ("POST", "/agent/chat/", "RECURSION", "Trailing-slash alias of /agent/chat"),
    ("POST", "/chat", "RECURSION", "The legacy service's own chat endpoint"),
    ("POST", "/chat/", "RECURSION", "Trailing-slash alias of /chat"),
